...
module.exports = {
	...
	entry: [
		...
		'./public/src/scripts' // This is where Webpack will be looking for the entry index.js file
	],
	output: {
	...
	resolve: {
		modules: [
			'node_modules',
			'public/src',
			path.resolve(__dirname, 'public/src/scripts'),
			path.resolve(__dirname, 'node_modules')
		], // Folders where Webpack is going to look for files to bundle together
		extensions: ['.jsx', '.js', '.scss'] // Extensions that Webpack is going to expect
	},
	module: {
	...
	plugins: [
		...
		new ExtractTextPlugin('./public/src/styles/style.css', {
			allChunks: true
		})
	]
}
