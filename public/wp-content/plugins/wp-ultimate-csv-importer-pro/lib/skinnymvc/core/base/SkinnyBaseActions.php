...
class SkinnyBaseActions {
	...
	public function call($module = 'default', $action = 'index', $request = array('GET' => array(), 'POST' => array())) {
		$moduleClass = SkinnyControllerWPCsvPro::camelize($module) . 'Actions';

		$actionMethod = 'execute' . SkinnyControllerWPCsvPro::camelize($action);
	...
	public function setLayout($layout) {
		SkinnyBaseControllerWPCsvPro::setLayout($layout);
	}
