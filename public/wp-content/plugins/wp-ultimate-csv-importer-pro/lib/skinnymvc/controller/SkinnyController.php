...
class SkinnyControllerWPCsvPro extends SkinnyBaseControllerWPCsvPro {
...
class CallSkinnyObj extends SkinnyControllerWPCsvPro {
	private static $_instance = null;

	public static function getInstance() {
		if (!is_object(self::$_instance)) //or if( is_null(self::$_instance) ) or if( self::$_instance == null )
		{
			self::$_instance = new SkinnyControllerWPCsvPro();
		}
